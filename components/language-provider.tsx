...
const pairs: [string, string][] = [
  ...
  ['Bir kaydı takip edin', 'Follow one record'], ['Kağıt ve banka operasyonunu azaltan, düşük ücretli ve izlenebilir ödeme yolculuğu.', 'A low-cost, traceable payment journey with less paperwork and fewer banking operations.'],
  ['Centerp ürün videosu', 'Centerp product video'], ['Centerp ERP ve Stellar ödeme ürün tanıtımı', 'Centerp ERP and Stellar payment product walkthrough'],
  ['Tam ekrandan çık', 'Exit fullscreen'], ['Tam ekran izle', 'Watch fullscreen'], ['AKIŞ HARİTASI', 'FLOW MAP'], ['İstediğiniz adımdan başlayın.', 'Start from any step.'],
  ['Her bölüm Centerp’in operasyon kaydını ödeme ve zincir kanıtıyla nasıl birleştirdiğini gösterir.', 'Each chapter shows how Centerp connects an operational record with payment and on-chain proof.'],
  ['Problem & vizyon', 'Problem & vision'], ['ERP kayıtları ile ödeme kanıtı arasındaki kopukluğu görün.', 'See the disconnect between ERP records and payment proof.'],
  ['ERP çalışma alanı', 'ERP workspace'], ['Satış, satın alma, stok, üretim ve ekip süreçlerini keşfedin.', 'Explore sales, purchasing, inventory, production and team workflows.'],
  ['TRY, USDC & escrow', 'TRY, USDC & escrow'], ['Anchor köprüsünden korumalı Stellar ödemesine ilerleyin.', 'Move from the Anchor bridge to a protected Stellar payment.'],
  ['Zincir kanıtı', 'Chain proof'], ['Fatura, işlem hash’i ve mutabakat kaydını doğrulayın.', 'Verify the invoice, transaction hash and reconciliation record.'],
  ['Şimdi oynatılıyor', 'Now playing'], ['Bu bölümü oynat', 'Play this chapter'], ['CANLI TESTNET DENEYİMİ', 'LIVE TESTNET EXPERIENCE'],
  ['İzlemekle kalmayın.', 'Do more than watch.'], ['Akışı kendiniz tamamlayın.', 'Complete the flow yourself.'],
  ['Hazır örnek verilerle sipariş oluşturun, faturayı Stellar’a taşıyın ve işlemin zincir kanıtını görün.', 'Create an order with ready-made sample data, move the invoice to Stellar and see its on-chain proof.'],
  ['ERP’yi aç', 'Open ERP'], ['Finans akışına git', 'Open finance flow'], ['108 saniyelik ürün demosu', '108-second product demo'],
  ...
  ['Banka talimatı oluşturulabilir. Son Stellar ödemesinden önce ERP alıcı kaydına Testnet cüzdanı ekleyin.', 'Bank instructions can be created. Add a Testnet wallet to the ERP recipient before the final Stellar payment.'],
  ['Alıcının Stellar cüzdanı eksik. ERP’de ilgili tedarikçi veya çalışan kaydına Testnet public key ekleyin.', 'The recipient’s Stellar wallet is missing. Add a Testnet public key to the related vendor or employee record in ERP.'],
  ['Önce ERP alıcı kaydına Stellar cüzdanı ekleyin.', 'Add a Stellar wallet to the ERP recipient record first.'],
