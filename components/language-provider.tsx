...
const pairs: [string, string][] = [
  ...
  ['Kayıtlar', 'Records'], ['Kalıcı yerel SQLite', 'Persistent local SQLite'], ['Kurulum bekliyor', 'Setup pending'],
  ...
  ['YEREL PARA, AÇIK BİR AĞ', 'LOCAL MONEY, AN OPEN NETWORK'], ['Bankayla blokzincir', 'Banking and blockchain'], ['aynı akışta.', 'in one flow.'], ['Cüzdanını doğrula', 'Verify your wallet'], ['Kuru sabitle, talimatı al', 'Lock the rate and get instructions'], ['Transferi tamamla & izle', 'Complete and track the transfer'], ['Anchor işlemleri', 'Anchor transactions'], ['Banka talimatları, kur teklifleri ve transfer durumları.', 'Bank instructions, quotes and transfer statuses.'], ['İlk transferinle köprüyü kur.', 'Create the bridge with your first transfer.'], ['BANKA TALİMATI', 'BANK INSTRUCTIONS'], ['Hedef', 'Destination'], ['Kontrol et', 'Check status'], ['USDC gönder & imzala', 'Send USDC & sign'], ['Banka transferini simüle et', 'Simulate bank transfer'],
  ...
  ['Anchor’a USDC gönderimi', 'Send USDC to Anchor'], ['Anchor çevrimiçi', 'Anchor online'], ['Bağlantı kontrol ediliyor', 'Checking connection'], ['Anchor işlemi', 'Anchor transaction'], ['Banka transferi simülasyonu', 'Bank transfer simulation'], ['Anchor’a USDC gönder', 'Send USDC to Anchor'],
